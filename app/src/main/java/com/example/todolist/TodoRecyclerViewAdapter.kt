...
class TodoRecyclerViewAdapter (private val todoList: ArrayList<TodoEntity>, private val listener: OnItemLongClickListener) : RecyclerView.Adapter<TodoRecyclerViewAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        when(todoData.importance){
            1-> {
                holder.tv_importance.setBackgroundResource(R.color.important1)
            }
            2-> {
                holder.tv_importance.setBackgroundResource(R.color.important2)
            }
            3-> {
                holder.tv_importance.setBackgroundResource(R.color.important3)
            }
        }
